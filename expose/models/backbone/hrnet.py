...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        final_conv_cfg = cfg.get('final_conv')
        #  self.conv_layers = make_conv_layer(3 * 384, final_conv_cfg)
        subsample3_cfg = self.stage3_cfg.get('subsample')
        subsample2_cfg = self.stage2_cfg.get('subsample')

        #  self.subsample_3, subsample_3_out_dim = make_subsample_layers(
        #  96, subsample3_cfg)
        #  self.subsample_2, subsample_2_out_dim = make_subsample_layers(
        #  192, subsample2_cfg)
        ...
        self.subsample_2 = self._make_subsample_layer(
            ...
            num_layers=1)
        #  logger.info(self.subsample_3.state_dict().keys())
